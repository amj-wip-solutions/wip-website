...
import { Mail, ArrowRight, Phone, MapPin, Calendar, Zap } from "lucide-react"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="inline-block px-6 py-3 bg-black text-white mb-8 shadow-lg">
              <p className="text-sm font-bold tracking-wider">LET'S TALK</p>
            </div>
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Free 30-minute consultation. No sales pitch—just honest advice on the best path forward for your project.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white border-2 border-gray-300 hover:border-teal-500 p-8 hover:-translate-y-2 transition-all duration-300 shadow-xl hover:shadow-2xl">
                ...
                <h3 className="text-xl font-bold text-black mb-2">Book a Call</h3>
            ...
            <div className="relative bg-black p-12 shadow-2xl">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <h3 className="text-3xl sm:text-4xl font-bold text-white mb-6 drop-shadow-lg">
                  Start Building in 2 Weeks or Less
                </h3>
                <p className="text-gray-300 text-xl mb-10 leading-relaxed font-medium">
                  We're accepting <span className="text-teal-400 font-bold">3 new projects this month</span>.
                  Get a detailed proposal with timeline and budget within 48 hours.
                </p>
                ...
                <div className="grid grid-cols-3 gap-8 pt-8 border-t-2 border-gray-800">
                  <div>
                    <div className="text-4xl font-bold text-teal-500 mb-2 drop-shadow-[0_0_15px_rgba(20,184,166,0.3)]">100%</div>
                    <div className="text-gray-400 text-sm font-medium">On-Time Delivery</div>
                    <div className="text-gray-500 text-xs mt-1">Or money back</div>
                  </div>
                  <div>
                    <div className="text-4xl font-bold text-white mb-2 drop-shadow-lg">14-Day</div>
                    <div className="text-gray-400 text-sm font-medium">Kickoff Guarantee</div>
                    <div className="text-gray-500 text-xs mt-1">Start fast</div>
                  </div>
                  <div>
                    <div className="text-4xl font-bold text-teal-500 mb-2 drop-shadow-[0_0_15px_rgba(20,184,166,0.3)]">6-Month</div>
                    <div className="text-gray-400 text-sm font-medium">Free Support</div>
                    <div className="text-gray-500 text-xs mt-1">Post-launch</div>
                  </div>
                </div>
              </div>
            </div>
