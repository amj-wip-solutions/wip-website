      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Smart & Robust Code for your business. Nearly a decade of delivering high-quality software solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">SaaS Development</a></li>
              ...
              <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">Code Modernization</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © 2025 WIP Solutions. All rights reserved.
          </p>
